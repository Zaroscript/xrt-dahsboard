...
const Settings = () => {
  ...
  const [moderatorToDelete, setModeratorToDelete] = useState<{ id: string; name: string } | null>(null);
  ...
  const handleCompanySettingsUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const updatedSettings = await companySettingsApi.updateSettings(companySettings);
      ...
      toast({
        title: "Error",
        description: error.response?.data?.message || "Failed to update company settings",
        variant: "destructive"
      });
    } finally {
  ...
  const handleEditClick = (mod: any) => {
    setEditingModerator({
      id: mod._id,
      name: mod.fName && mod.lName ? `${mod.fName} ${mod.lName}` : mod.name || '',
      email: mod.email,
  ...
  return (
    ...
    >
      ...
      <div className="mb-8 space-y-2">
        ...
        <p className="text-muted-foreground text-base">Manage your account, company information, and team settings</p>
      </div>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="mt-1">Update your personal details and public profile</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                  ...
                  <form onSubmit={handleProfileUpdate} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="transition-all focus:ring-2 focus:ring-primary/20"
                      />
                      <p className="text-xs text-muted-foreground mt-1">This email will be used for account notifications</p>
                    </div>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="mt-1">Manage your password and security settings</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="mt-1">
                      Manage your company details that will appear on invoices and documents
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                {isLoadingCompanySettings ? (
                  ...
                  <form onSubmit={handleCompanySettingsUpdate} className="space-y-8">
                    {/* Logo Upload Section */}
                    <div className="space-y-4 p-6 rounded-lg border bg-muted/30">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Upload your company logo to display on invoices and documents
                        </p>
                      </div>
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Recommended: JPG, PNG or GIF. Max size 5MB. Optimal dimensions: 200x200px or higher.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">How clients can reach your company</p>
                      </div>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="mt-1">Manage moderators who have access to the dashboard</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                    ...
                    >
                      <div className="p-5 rounded-lg border bg-muted/30 space-y-4">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground">Create a new team member with dashboard access</p>
                        </div>
                        <form onSubmit={handleAddModerator} className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-2">
                              <Label htmlFor="modName" className="text-sm font-medium">Full Name</Label>
                              <Input 
                                id="modName" 
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="modEmail" className="text-sm font-medium">Email Address</Label>
                              <Input 
                                id="modEmail" 
                                type="email" 
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="modPassword" className="text-sm font-medium">Password (Optional)</Label>
                              <Input 
                                id="modPassword" 
                                type="password" 
                                ...
                                className="transition-all focus:ring-2 focus:ring-primary/20"
                              />
                              <p className="text-xs text-muted-foreground">Leave empty for auto-generated password</p>
                            </div>
                          </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-base font-semibold">Active Moderators</h3>
                      <div className="flex items-center gap-3">
                        {moderators && moderators.length > 0 && (
                          <span className="text-sm text-muted-foreground">{moderators.length} {moderators.length === 1 ? 'member' : 'members'}</span>
                        )}
                      </div>
                    </div>
                    {isLoadingModerators && (!moderators || moderators.length === 0) ? (
                      <div className="flex flex-col items-center justify-center py-12 space-y-4">
                        <Loader2 className="h-8 w-8 animate-spin text-muted-foreground" />
                      ...
                      <div className="text-center py-12 space-y-3">
                        ...
                        <div>
                          <p className="text-base font-medium text-foreground">Error loading moderators</p>
                          <p className="text-sm text-muted-foreground mt-1">{moderatorError}</p>
                          <Button 
                            variant="outline" 
                            size="sm" 
                            className="mt-4"
                      ...
                      <div className="text-center py-12 space-y-3">
                        ...
                        <div>
                          <p className="text-base font-medium text-foreground">No moderators found</p>
                          ...
                          >
                            <div className="flex items-center gap-4 flex-1 min-w-0">
                              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-semibold text-sm flex-shrink-0">
                                {mod.fName?.[0] || mod.name?.[0] || 'U'}{mod.lName?.[0] || ''}
                              </div>
                              <div className="flex-1 min-w-0">
                                <p className="font-medium text-base truncate">
                                  {mod.fName && mod.lName ? `${mod.fName} ${mod.lName}` : mod.name || 'Unknown'}
                                </p>
                                <p className="text-sm text-muted-foreground truncate">{mod.email}</p>
                                {mod.plainPassword && (
                            ...
                            {user?.role === 'super_admin' && (
                              <div className="flex items-center gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <Button 
                                  ...
                                  onClick={() => handleRemoveModerator(mod._id, `${mod.fName} ${mod.lName}`)}
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[500px] border-border/50 shadow-lg">
          <DialogHeader className="space-y-3">
            <DialogTitle className="text-xl font-semibold text-foreground">Edit Moderator</DialogTitle>
          ...
          {editingModerator && (
            <form onSubmit={handleUpdateModerator} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="editName" className="text-sm font-medium text-foreground">Full Name</Label>
                <Input 
                  id="editName" 
              ...
              <div className="space-y-2">
                <Label htmlFor="editEmail" className="text-sm font-medium text-foreground">Email Address</Label>
                <Input 
                  id="editEmail" 
                  type="email" 
              ...
              <div className="space-y-2">
                <Label htmlFor="editPassword" className="text-sm font-medium text-foreground">New Password (Optional)</Label>
                <Input 
                  id="editPassword" 
                  type="password" 
                ...
                />
                <p className="text-xs text-muted-foreground">Must be at least 8 characters if provided</p>
              </div>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove <span className="font-semibold">{moderatorToDelete?.name}</span> as a moderator? 
              This action cannot be undone and will revoke their administrative access.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
